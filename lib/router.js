...
userChannelController = BaseController.extend({
    template : 'userChannel',
    layoutTemplate : 'channelLayout',
    path : '/channel/of/:userId',
    waitOn : function(){
        ...
        return [
            ...
            Meteor.subscribe('current_player',userId),
            Meteor.subscribe('current_playlist',userId)
        ]
    },
    channel : function(){
    ...
    player : function(){
        return Players.findOne({channelId : this.params.userId});
    },
    playlist : function(){
    ...
    action : function(){
        ...
        this.state.set('player', this.player());
        this.state.set('playlist', this.playlist());
        this.render()
    },
    fastRender : true
})
...
Meteor.startup(function(){
    ...
    Router.route('/channel/of/:userId',{
        name : 'userChannel',
